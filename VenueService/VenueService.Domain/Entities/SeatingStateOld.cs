...
public class SeatingStateOld: EntityBase
{
    public Dictionary<char, List<Seat>> State;
    public bool SeatNumbersDescend;
    public int Capacity;
    
    public SeatingStateOld(SeatingLayoutOld seatingLayoutOld, bool seatNumbersDescend = false)
    {
        State = new Dictionary<char, List<Seat>>();
        SeatNumbersDescend = seatNumbersDescend;
        Capacity = 0;
        
        foreach (var seat in seatingLayoutOld.Layout)
        {
